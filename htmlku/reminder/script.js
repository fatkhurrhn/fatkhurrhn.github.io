...
var { value: jawaban } = await swals.fire({
  title: 'Bismillah InsyaAllah', input: 'text', allowOutsideClick: false, showCancelButton: false,
});
if(jawaban && jawaban.length < 19){
  window.jawaban = jawaban;
  pesanwhatsapp = jawaban;
  await swals.fire('OK!', 'share ke temen mu juga yaa biar sama-sama tau 😅', 'success');
